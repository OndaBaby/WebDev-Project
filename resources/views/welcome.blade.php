        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="mt-16">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    {{-- <div class="bg-white rounded-lg shadow-md p-6">
                        <h3 class="text-xl font-bold mb-4 roboto-font">Recently Added</h3>
                        <!-- Display recently added products here -->
                    </div>
                    <div class="bg-white rounded-lg shadow-md p-6">
                        <h3 class="text-xl font-bold mb-4 roboto-font">Popular Categories</h3>
                        <!-- Display popular product categories here -->
                    </div> --}}
                </div>
            </div>
        </div>
