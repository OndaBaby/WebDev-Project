...
@section('content')
    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                {!! Form::model($supplier, ['route' => ['supplier.update', $supplier->id], 'class' => 'form', 'files' => true, 'method' => 'post']) !!}
                    <div class="form-group">
                        {{ Form::label('name', 'Name') }}
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::text('email', null, ['class' => 'form-control', 'placeholder' => 'Enter supplier email']) }}
                        @error('email')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        {{ Form::text('contact_number', null, ['class' => 'form-control', 'placeholder' => 'Enter the contact number']) }}
